...
After running the container, unpack the `submission.tar.gz` generated by your solution obtain the matches files to provide to `vsc2022/descriptor_eval.py` along with the training set ground truth to obtain your score.
